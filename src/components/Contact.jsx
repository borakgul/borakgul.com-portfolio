...
const socialLinks = [
  {
    href: 'https://www.github.com/borakgul',
    icon: (
  ...
  {
    href: 'https://www.linkedin.com/in/borakgul',
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  {
    href: 'https://www.instagram.com/borakgul',
    icon: (
  ...
  return (
    <section id="contact" className="section">
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        ...
        <form
          action="https://getform.io/f/aroyvzvb"
          method="POST"
        ...
        >
          ...
          <button
            type="submit"
            className="w-full justify-center inline-flex items-center gap-2 text-sm font-semibold text-white bg-gradient-to-r from-zinc-900 to-rose-700 hover:from-zinc-800 hover:to-rose-600 px-4 py-2 rounded-md shadow-md transition-all duration-200"
          >
            {t('contact.submit')}
          </button>
        </form>
